...
class DateFormatter {
  DateTime parseDateString(String createdAtString) {
    ...
    final DateTime date =
        DateTime(year, _parseMonth(month), day, hour, minute, second);
    print('date parse string : $date');
    return date;
  }
  ...
  String formatDateAndTimeShort(value) {
    String formattedDate = DateFormat('HH:mm dd-MM ').format(value);
    return formattedDate;
  }
