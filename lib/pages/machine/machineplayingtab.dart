                ...
                switch (state.status) {
                  ...
                  case MachineStatus.success:
                    if (state.machines.isEmpty) {
                      return const Center(child: Text('No machine playing found'));
                    }
                    ...
                    return Stack(
                      children: [
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return itemListUserBlocMachine(
                                    hasShowImage: state.machinesSearch.isNotEmpty ? false : true ,
                                    key: ValueKey(machineList![index].number), // Pass a unique key here
                                    onPress: () {
                                    ...
                                    machine: machineList[index].machineNumber.isNotEmpty ? machineList[index].machineNumber.last : "",
                                    width: width,
                       ...
                       //show total results
                       resultRow(context: context, total: machineList.length)
                      ],
                    );
                }
              }),
